  ...
  <div class="row">
    <div class="col-12" style="text-align: center">
      <form method="post" >
        ...
        <c:if test="${requestScope['success']!=null}">
          <label class="alert alert-primary" style="color: green" >Create Singer success!</label>
        </c:if>
        ...
        <table>
          ...
          <tr style="text-align: center">
            <td colspan="2">
              <button class="btn btn-primary" id="btn-create" type="submit">Create Singer</button>
            </td>
          </tr>
        </table>
      </form>
